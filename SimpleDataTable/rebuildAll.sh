...
./createPackageVersion.sh $1 $2 "Base Setup" baseSetup "Setup.default();" "" $3
./createPackageVersion.sh $1 $2 "Simple Data Table" simpleDataTable "" "" $3
./createPackageVersion.sh $1 $2 "Data Table" dataTable "" "" $3
